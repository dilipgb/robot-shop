# Sample Microservice Application(For s390x Architecture)

Stan's Robot Shop is a sample microservice application you can use as a sandbox to test and learn containerised application orchestration and monitoring techniques. It is not intended to be a comprehensive reference example of how to write a microservices application, although you will better understand some of those concepts by playing with Stan's Robot Shop. To be clear, the error handling is patchy and there is not any security built into the application.

You can get more detailed information from [blog post](https://www.instana.com/blog/stans-robot-shop-sample-microservice-application/) about this sample microservice application.
...
Note: The above docker-compose build script is not compatible with Z Arch. yet
[Click here](https://github.ibm.com/IBMPrivateCloud/robot-shop/tree/master/K8s#stans-robot-shop---pre-req-image-building-setup) to build images for Z 

## Run Locally
You can run it locally for testing.

Update image section of docker-compose.yaml file with local image path
...
Note: This Microservice is made compatible with s390x architecture, which is build by Referring https://github.com/instana/robot-shop .
